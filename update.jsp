...
<html>
    ...
    <body style=" background-image:url(image/2.jpg);font-weight:bold; font-size:200%; color:white ;background-repeat:no-repeat;background-size: 100% ;">
        <form name="myform" action="updatedata.jsp">
     <div id="second">
            <center><table>
...
<tr><td>Employee Id:  </td><td><input type="number" name="username"/></td></tr>
	<tr><td><br></td></tr>
